$(document).ready(function () {
    $('#tambahPeraturanInternasional').on('click', function () {
        Swal.fire({
            title: 'Tambah Peraturan Internasional',
            html: `
                <form id="peraturanInternasional" action="/peraturan_internasional" method="POST" enctype="multipart/form-data">
            ...
            preConfirm: () => {
                const form = $('#peraturanInternasional');
    ...
    $('.filePdf').on('click', function () {
        ...
        Swal.fire({
            title: "Detail Peraturan Internasional",
            html: `
                <div class="row h-100">
