$(document).ready(function () {
    $('#tambahPeraturanPresiden').on('click', function () {
        Swal.fire({
            title: 'Tambah Peraturan Presiden',
            html: `
                <form id="peraturanPresiden" action="/peraturan_presiden" method="POST" enctype="multipart/form-data">
    ...
    $('.filePdf').on('click', function () {
        ...
        Swal.fire({
            title: "Detail Peraturan Presiden",
            html: `
                <div class="row h-100">
