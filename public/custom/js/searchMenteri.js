$(document).ready(function () {
    $('#tambahPeraturanMenteri').on('click', function () {
        Swal.fire({
            title: 'Tambah Peraturan Menteri',
            html: `
                <form id="peraturanMenteri" action="/peraturan_menteri" method="POST" enctype="multipart/form-data">
