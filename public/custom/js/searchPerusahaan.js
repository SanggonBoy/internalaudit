$(document).ready(function () {
    $('#tambahPeraturanPerusahaan').on('click', function () {
        Swal.fire({
            title: 'Tambah Peraturan Perusahaan',
            html: `
                <form id="peraturanPerusahaan" action="/peraturan_perusahaan" method="POST" enctype="multipart/form-data">
            ...
            preConfirm: () => {
                const form = $('#peraturanPerusahaan');
    ...
    $('.filePdf').on('click', function () {
        ...
        Swal.fire({
            title: "Detail Peraturan Perusahaan",
            html: `
                <div class="row h-100">
