    ...
    <header class="py-5 bg-dark border-bottom mb-2">
        <div class="container mb-4">
            <div class="text-start text-light my-3 mt-5">
                <br>
                <h1 class="fw-bolder">Laporan Hasil Audit</h1>
                <p>Silahkan ketik kata kunci berdasarkan laporan yang anda cari</p>
            </div>
            <!-- Search Form -->
    ...
    <div class="container">
        <div class="custom-card mb-5 mt-5">
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="card mb-4 position-relative" style="border-left: 5px solid #000000;">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">Laporan Hasil Audit Penghitungan Gaji</h4>
                            <p class="card-text">
                                Laporan ini berisi hasil audit keuangan pada divisi Finance, termasuk evaluasi arus kas, pengelolaan anggaran, dan kepatuhan terhadap kebijakan perusahaan.
                            </p>
                ...
                <div class="col-lg-4">
                    <!-- Search widget-->
                    <div class="card mb-4" style="border-left: 5px solid #000000;">
                        <div class="card-body">
                            <form>
                                <!-- Kata Kunci -->
                                <div class="mb-3">
