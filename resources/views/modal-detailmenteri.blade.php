        ...
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title" id="detailModalLabel">
                    Detail<span class="text-dark">&nbsp;Peraturan Menteri Keuangan</span>
                </h2>
                        ...
                        <table class="table table-border mb-3">
                            <tbody>
                                <tr>
                                    ...
                                    <td>Peraturan Menteri Keuangan No. 12 Tahun 2024</td>
                                </tr>
                                <tr>
                                    <th class="text-muted">Nama Peraturan</th>
                                    <td>Kebijakan Fiskal untuk Stabilitas Ekonomi</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        Peraturan ini mengatur kebijakan fiskal yang bertujuan untuk menjaga stabilitas ekonomi serta meningkatkan pertumbuhan investasi di Indonesia.
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>Stabilitas Ekonomi dan Investasi</td>
                                </tr>
                                <tr>
