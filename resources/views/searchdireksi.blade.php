    ...
    <header class="py-5 bg-dark border-bottom mb-2">
        <div class="container mb-4">
            <div class="text-start text-light my-3 mt-5">
                <h1 class="fw-bolder">Peraturan Direksi apa yang kamu cari?</h1>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="card mb-4 position-relative" style="border-left: 5px solid #000000;">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">Peraturan Direksi No. 12 Tahun 2024</h4>
                            <p class="card-text">
                                Peraturan ini mengatur percepatan pembangunan infrastruktur proyek Kereta Cepat
                                Jakarta-Bandung untuk meningkatkan konektivitas.
                            </p>
