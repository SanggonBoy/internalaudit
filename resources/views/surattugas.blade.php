    ...
    <header class="py-5 bg-dark border-bottom mb-2">
        <div class="container mb-4">
            <div class="text-start text-light my-3 mt-5">
                <h1 class="fw-bolder">Surat Tugas apa yang ingin kamu cari?</h1>
                <p>Silahkan ketik kata kunci berdasarkan surat yang anda cari</p>
            </div>
            <!-- Search Form -->
        ...
        <div class="custom-card mb-5 mt-5">
            <div class="row">
                <div class="col-12 d-flex justify-content-between align-items-center">
                    <h2 class="my-4">Daftar Surat Tugas.</h2>
                ...
                <div class="col-lg-8">
                    <div class="card mb-4 position-relative" style="border-left: 5px solid #000000;">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">Surat Tugas Audit Efisiensi Penggunaan Material</h4>
                            <p class="card-text">
                                Surat ini memberikan mandat kepada tim audit untuk mengevaluasi efektivitas penggunaan material dalam proyek 
                                konstruksi guna mengidentifikasi potensi pemborosan dan memastikan kepatuhan terhadap standar efisiensi.
                            </p>
                            <button class="btn btn-outline-dark" data-bs-toggle="modal" data-bs-target="#detailModal">Selengkapnya</button>
                        </div>
                    </div>

                    @include('modal-detailst')
                    
                    <div class="card mb-4 position-relative" style="border-left: 5px solid #000000;">
                        <div class="card-body">
                            <span class="badge bg-success position-absolute top-0 end-0 m-3">Berlaku</span>
                            <div class="small text-muted">September 5, 2024</div>
                            <h4 class="card-title">Surat Tugas Audit Kepatuhan Prosedur Pengadaan</h4>
                            <p class="card-text">
                                Surat tugas ini menetapkan tim audit untuk meninjau kepatuhan terhadap kebijakan pengadaan barang dan jasa, 
                                memastikan proses berjalan sesuai regulasi serta transparansi dalam pemilihan vendor.
                            </p>
                    ...
                    <div class="card mb-4 position-relative" style="border-left: 5px solid #000000;">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">Surat Tugas Audit Validasi Laporan Keuangan</h4>
                            <p class="card-text">
                                Tim audit ditugaskan untuk melakukan pemeriksaan terhadap laporan keuangan semester I guna memastikan 
                                keakuratan pencatatan, kepatuhan terhadap standar akuntansi, serta keandalan informasi keuangan.
                            </p>
                            <a class="btn btn-outline-dark" href="#!">Selengkapnya</a>
                        </div>
                    </div>
                    ...
                    <div class="card mb-4 position-relative" style="border-left: 5px solid #000000;">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">Surat Tugas Audit Investigasi Dugaan Penyimpangan</h4>
                            <p class="card-text">
                                Tim audit diberikan wewenang untuk menyelidiki dugaan penyimpangan dalam penggunaan dana operasional 
                                berdasarkan temuan awal yang mengindikasikan adanya ketidaksesuaian dalam laporan keuangan internal.
                            </p>
                            <a class="btn btn-outline-dark" href="#!">Selengkapnya</a>
                        </div>
                    </div>
                    ...
                    <div class="card mb-4 position-relative" style="border-left: 5px solid #000000;">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">Surat Tugas Audit Keamanan Infrastruktur IT</h4>
                            <p class="card-text">
                                Tim audit ditugaskan untuk melakukan evaluasi terhadap keamanan infrastruktur IT guna mengidentifikasi 
                                potensi kerentanan sistem, risiko siber, serta memastikan kepatuhan terhadap kebijakan keamanan data.
                            </p>
                            <a class="btn btn-outline-dark" href="#!">Selengkapnya</a>
                        </div>
                    </div>                               
