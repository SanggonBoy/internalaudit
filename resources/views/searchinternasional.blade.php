    ...
    <header class="py-5 bg-dark border-bottom mb-2">
        <div class="container mb-4">
            <div class="text-start text-light my-3 mt-5">
                <h1 class="fw-bolder">Peraturan Internasional apa yang kamu cari?</h1>
        ...
        <div class="custom-card mb-5 mt-5">
            <div class="row">
                <div class="col-12 d-flex justify-content-between align-items-center">
                    <h2 class="my-4">Daftar Peraturan Internasional.</h2>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="card mb-4 position-relative" style="border-left: 5px solid #000000;">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">International Standard on Auditing (ISA) 200</h4>
                            <p class="card-text">
                            ...
                            <button class="btn btn-outline-dark" data-bs-toggle="modal" data-bs-target="#detailModal">Selengkapnya</button>
                        </div>
                    </div>
                    
                    @include('modal-detailinternasional')
                    
                    <div class="card mb-4 position-relative" style="border-left: 5px solid #000000;">
                        <div class="card-body">
                            <span class="badge bg-success position-absolute top-0 end-0 m-3">Berlaku</span>
                            <div class="small text-muted">September 5, 2024</div>
                            <h4 class="card-title">International Standard on Auditing (ISA) 315</h4>
                            <p class="card-text">
                                Standar ini menetapkan prosedur untuk mengidentifikasi dan menilai risiko kesalahan material dalam laporan keuangan.
                            </p>
                    ...
                    <div class="card mb-4 position-relative" style="border-left: 5px solid #000000;">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">International Ethics Standards Board for Accountants (IESBA) Code</h4>
                            <p class="card-text">
                                Kode etik ini memberikan panduan bagi auditor dan akuntan dalam menjaga independensi dan integritas dalam audit.
                            </p>
                            <a class="btn btn-outline-dark" href="#!">Selengkapnya</a>
                        </div>
                    </div>
                    ...
                    <div class="card mb-4 position-relative" style="border-left: 5px solid #000000;">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">Sarbanes-Oxley Act (SOX) 2002</h4>
                            <p class="card-text">
                                Peraturan ini mengatur kewajiban perusahaan publik dalam menerapkan kontrol internal untuk mencegah kecurangan keuangan.
                            </p>
                            <a class="btn btn-outline-dark" href="#!">Selengkapnya</a>
                        </div>
                    </div>
                    ...
                    <div class="card mb-4 position-relative" style="border-left: 5px solid #000000;">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">International Standard on Assurance Engagements (ISAE) 3000</h4>
                            <p class="card-text">
                                Standar ini memberikan panduan untuk pelaksanaan audit dan asurans non-keuangan seperti kepatuhan dan keberlanjutan.
                            </p>
                            <a class="btn btn-outline-dark" href="#!">Selengkapnya</a>
                        </div>
                    </div>
                    ...
                    <div class="card mb-4 position-relative" style="border-left: 5px solid #000000;">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">Public Company Accounting Oversight Board (PCAOB) Standards</h4>
                            <p class="card-text">
                                Standar ini berlaku untuk audit perusahaan publik di AS dan mengatur transparansi serta akuntabilitas auditor.
                            </p>
                            <a class="btn btn-outline-dark" href="#!">Selengkapnya</a>
                        </div>
                    </div>
                    ...
                    <div class="card mb-4 position-relative" style="border-left: 5px solid #000000;">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">General Data Protection Regulation (GDPR) Audit</h4>
                            <p class="card-text">
                                Audit ini mengevaluasi kepatuhan perusahaan terhadap peraturan perlindungan data di Uni Eropa.
                            </p>
                            <a class="btn btn-outline-dark" href="#!">Selengkapnya</a>
                        </div>
                    </div>
                    ...
                    <div class="card mb-4 position-relative" style="border-left: 5px solid #000000;">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">ISO 9001:2015 Audit</h4>
                            <p class="card-text">
                                Audit ini memastikan sistem manajemen mutu perusahaan telah memenuhi standar internasional untuk kualitas.
                            </p>
                            <a class="btn btn-outline-dark" href="#!">Selengkapnya</a>
                        </div>
                    </div>
                    ...
                    <div class="card mb-4 position-relative" style="border-left: 5px solid #000000;">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">COSO Internal Control Framework</h4>
                            <p class="card-text">
                                Kerangka ini membantu organisasi dalam merancang dan mengevaluasi efektivitas sistem pengendalian internal mereka.
                            </p>
                            <a class="btn btn-outline-dark" href="#!">Selengkapnya</a>
                        </div>
                    </div>                                        
                    ...
                    <nav aria-label="Pagination">
                        <ul class="pagination justify-content-center my-4">
                            <li class="page-item disabled">
                                <a class="page-link btn-dark" href="#" tabindex="-1"
                                    aria-disabled="true">Newer</a>
                            </li>
                            <li class="page-item active" aria-current="page">
                                <a class="page-link btn-dark" href="#!">1</a>
                            </li>
                            <li class="page-item">
                                <a class="page-link btn-dark" href="#!">2</a>
                            </li>
                            <li class="page-item">
                                <a class="page-link btn-dark" href="#!">3</a>
                            </li>
                            <li class="page-item disabled">
                                <a class="page-link btn-dark" href="#!">...</a>
                            </li>
                            <li class="page-item">
                                <a class="page-link btn-dark" href="#!">15</a>
                            </li>
                            <li class="page-item">
                                <a class="page-link btn-dark" href="#!">Older</a>
                            </li>
                        </ul>
                    </nav>
                </div>
