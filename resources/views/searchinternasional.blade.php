...
<body>
    ...
    <div class="container">
        <div class="custom-card mb-5 mt-5">
            <div class="row">
                ...
                @canany(['admin', 'viewer'])
                    <div class="col-12 mb-4 d-flex justify-content-between align-items-center">
                        <a href="#" id="tambahPeraturanInternasional" class="btn border border-dark"
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    @foreach ($peraturan_internasional as $item)
                    <div class="card mb-4 position-relative" style="border-left: 5px solid #000000;">
                        <div class="card-body">
                            <span
    ...
    <script src="{{ asset('custom/js/searchInternasional.js') }}"></script>
    @if (session('success'))
        <script>
            Swal.fire({
                icon: 'success',
