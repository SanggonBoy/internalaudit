    ...
    <header class="py-5 bg-dark border-bottom mb-2">
        <div class="container mb-4">
            <div class="text-start text-light my-3 mt-5">
                <h1 class="fw-bolder">Minutes Of Meeting.</h1>
                <p>Silahkan ketik kata kunci berdasarkan dokumen yang anda cari</p>
            </div>
            <!-- Search Form -->
        ...
        <div class="custom-card mb-5 mt-5">
            <div class="row">
                <div class="col-12 d-flex justify-content-between align-items-center">
                    <h2 class="my-4">Daftar Minutes Of Meeting.</h2>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="card mb-4 position-relative" style="border-left: 5px solid #000000;">
                        <div class="card-body">
                            ...
                            <div class="small text-muted">15 Oktober 2024</div>
                            <h4 class="card-title">MoM Tinjauan Kepatuhan Perusahaan</h4>
                            <p class="card-text">
                    ...
                    <div class="card mb-4 position-relative" style="border-left: 5px solid #000000;">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">MoM Evaluasi Kinerja Internal</h4>
                            <p class="card-text">
                                Pembahasan terkait efektivitas dan efisiensi pelaksanaan prosedur di lingkungan PT KCIC.
                            </p>
                    ...
                    <div class="card mb-4 position-relative" style="border-left: 5px solid #000000;">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">MoM Monitoring dan Pengawasan Proses</h4>
                            <p class="card-text">
                                Diskusi terkait pengawasan pelaksanaan operasional guna memastikan efisiensi dan
                                efektivitas kerja.
                            </p>
                            <a class="btn btn-outline-dark" href="#!">Selengkapnya</a>
                        </div>
                    ...
                    <div class="card mb-4 position-relative" style="border-left: 5px solid #000000;">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">MoM Pemeriksaan dan Verifikasi Laporan</h4>
                            <p class="card-text">
                                Pembahasan mengenai metode validasi data dan laporan untuk memastikan transparansi dan
                                akurasi informasi.
                            </p>
                            <a class="btn btn-outline-dark" href="#!">Selengkapnya</a>
                        </div>
                    ...
                    <div class="card mb-4 position-relative" style="border-left: 5px solid #000000;">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">MoM Peninjauan Tata Kelola Perusahaan</h4>
                            <p class="card-text">
                                Evaluasi terkait penerapan prinsip tata kelola perusahaan yang baik untuk meningkatkan
                                efektivitas bisnis.
                            </p>
                            <a class="btn btn-outline-dark" href="#!">Selengkapnya</a>
                        </div>
                    ...
                    <div class="card mb-4 position-relative" style="border-left: 5px solid #000000;">
                        <div class="card-body">
                            <span class="badge bg-success position-absolute top-0 end-0 m-3">Berlaku</span>
                            <div class="small text-muted">10 Mei 2024</div>
                            <h4 class="card-title">MoM Peningkatan Standar Prosedur</h4>
                            <p class="card-text">
                                Diskusi mengenai pembaruan dan peningkatan prosedur operasional untuk meningkatkan
                                efisiensi kerja.
                            </p>
                            <a class="btn btn-outline-dark" href="#!">Selengkapnya</a>
                        </div>
                    ...
                    <div class="card mb-4 position-relative" style="border-left: 5px solid #000000;">
                        <div class="card-body">
                            <span class="badge bg-danger position-absolute top-0 end-0 m-3">Kadaluarsa</span>
                            <div class="small text-muted">22 April 2024</div>
                            <h4 class="card-title">MoM Pengelolaan Risiko Operasional</h4>
                            <p class="card-text">
                                Pembahasan strategi mitigasi risiko dalam operasional perusahaan untuk menghindari
                    ...
                    <div class="card mb-4 position-relative" style="border-left: 5px solid #000000;">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">MoM Kepatuhan dan Regulasi</h4>
                            <p class="card-text">
                                Tinjauan mengenai penerapan peraturan internal dan eksternal untuk memastikan kepatuhan
                                perusahaan.
                            </p>
                            <a class="btn btn-outline-dark" href="#!">Selengkapnya</a>
                        </div>
                    ...
                    <div class="card mb-4 position-relative" style="border-left: 5px solid #000000;">
                        <div class="card-body">
                            <span class="badge bg-danger position-absolute top-0 end-0 m-3">Kadaluarsa</span>
                            <div class="small text-muted">18 Februari 2024</div>
                            <h4 class="card-title">MoM Evaluasi Penggunaan Anggaran</h4>
                            <p class="card-text">
                                Laporan evaluasi pemanfaatan anggaran operasional dan rekomendasi peningkatan efisiensi
                                biaya.
                            </p>
                            <a class="btn btn-outline-dark" href="#!">Selengkapnya</a>
                        </div>
                    ...
                    <div class="card mb-4 position-relative" style="border-left: 5px solid #000000;">
                        <div class="card-body">
                            <span class="badge bg-success position-absolute top-0 end-0 m-3">Berlaku</span>
                            <div class="small text-muted">5 Januari 2024</div>
                            <h4 class="card-title">MoM Peningkatan Kualitas Pengawasan</h4>
                            <p class="card-text">
                                Pembahasan mengenai penguatan mekanisme pemantauan untuk meningkatkan kepatuhan dan
                                efektivitas kerja.
                            </p>
                            <a class="btn btn-outline-dark" href="#!">Selengkapnya</a>
                        </div>
