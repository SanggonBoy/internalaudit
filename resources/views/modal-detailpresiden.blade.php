        ...
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title" id="detailModalLabel">
                    Detail<span class="text-dark">&nbsp;Peraturan Presiden</span>
                </h2>
                        ...
                        <table class="table table-border mb-3">
                            <tbody>
                                <tr>
                                    ...
                                    <td>Peraturan Presiden No. 12 Tahun 2024</td>
                                </tr>
                                <tr>
                                    <th class="text-muted">Nama Peraturan</th>
                                    <td>Strategi Percepatan Pembangunan Infrastruktur Nasional</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        Peraturan ini mengatur strategi percepatan pembangunan infrastruktur nasional guna meningkatkan konektivitas dan daya saing Indonesia di kancah global.
                                    </td>
                                </tr>
                                <tr>
