    ...
    <header class="py-5 bg-dark border-bottom mb-2">
        <div class="container mb-4">
            <div class="text-start text-light my-3 mt-5">
                <h1 class="fw-bolder">Berita Acara apa yang kamu cari?</h1>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="card mb-4 position-relative" style="border-left: 5px solid #000000;">
                        <div class="card-body">
                            ...
                            <div class="small text-muted">10 Maret 2024</div>
                            <h4 class="card-title">Berita Acara Serah Terima Dokumen Kontrak</h4>
                            <p class="card-text">
                                Berita acara ini mencatat serah terima dokumen kontrak antara perusahaan dan mitra kerja
                                sebagai bukti resmi kesepakatan kerja sama.
                            </p>
