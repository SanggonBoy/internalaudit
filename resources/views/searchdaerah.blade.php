...
<body>
    ...
    <header class="py-5 bg-dark border-bottom mb-2">
        <div class="container mb-4">
            <div class="text-start text-light my-3 mt-5">
                <h1 class="fw-bolder">Peraturan Daerah apa yang kamu cari?</h1>
        ...
        <div class="custom-card mb-5 mt-5">
            <div class="row">
                <div class="col-12 mb-4 d-flex justify-content-between align-items-center">
                    <h2 class="my-4">Daftar Peraturan Daerah.</h2>
                    <h2 class="my-4">Pencarian!</h2>
                </div>
                @canany(['admin', 'viewer'])
                    <div class="col-12 mb-4 d-flex justify-content-between align-items-center">
                        <a href="#" id="tambahPeraturanDaerah" class="btn border border-dark"
                ...
                <div class="col-lg-8">
                    ...
                    <div class="card mb-4 position-relative" style="border-left: 5px solid #000000;">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">Peraturan Daerah No. 12 Tahun 2024</h4>
                            <p class="card-text">
    ...
    <script src="{{ asset('custom/js/searchDaerah.js') }}"></script>
    @if (session('success'))
        <script>
            Swal.fire({
                icon: 'success',
