        ...
        <div class="row justify-content-center">
            <div class="col-12 text-center">
                <h3 class="my-4 mb-4 mt-5" style="position: relative; display: inline-block;">
                    <span>Daftar</span>
                    <span class="text-dark">Kertas Kerja Audit Pengelolaan Pendapatan Farebox dan Non-farebox
                        (Farebox)</span>
                    <span class="mt-3"
                            ...
                            <table class="table table-bordered table-hover align-middle" style="border-color: black;">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>Surat Tugas Audit Pengelolaan Pendapatan Farebox</td>
                                        <td>Surat Tugas</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>Surat Tugas Audit Non-Farebox: Penyewaan dan Iklan</td>
                                        <td>Surat Tugas</td>
                                        <td style="text-align: center;">
                                            <button type="button" class="btn btn-outline-dark"
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center;">2024</td>
                                        <td>Dokumen Evaluasi Pengendalian Internal atas Pendapatan Farebox</td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center;">2023</td>
                                        <td>Analisis Risiko dalam Pengelolaan Tiket dan Tarif</td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center;">2024</td>
                                        <td>Ringkasan Temuan Audit atas Penerimaan Pendapatan Farebox</td>
                                        <td>Temuan Audit</td>
                                        <td style="text-align: center;">
                                            <button type="button" class="btn btn-outline-dark"
                                    ...
                                    <tr>
                                        ...
                                        <td>Laporan Pengujian Substantif atas Transaksi Tiket</td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center;">2024</td>
                                        <td>Surat Pernyataan Manajemen atas Keakuratan Data Penjualan Tiket</td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center;">2023</td>
                                        <td>Checklist Kepatuhan SOP Farebox dan Non-Farebox</td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center;">2024</td>
                                        <td>Konfirmasi Pihak Ketiga atas Pendapatan Non-Farebox</td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center;">2023</td>
                                        <td>Rekonsiliasi Pendapatan Farebox dan Laporan Keuangan</td>
                                        <td>Rekonsiliasi</td>
                                        <td style="text-align: center;">
                                            <button type="button" class="btn btn-outline-dark"
